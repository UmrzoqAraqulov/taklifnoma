...
const translationsData: Record<Language, Translations> = {
  ru: {
    ...
    venuebadge: "✦ Локация ✦",
    venuesubtitle: "Где любовь встречается с элегантностью",
  ...
  en: {
    ...
    venuebadge: "✦ Location ✦",
    venuesubtitle: "Where love meets elegance",
  ...
  uz: {
    ...
    venuebadge: "✦ Manzil ✦",
    venuesubtitle: "Sevgi va nafosat uyg‘unligi",
    googlemaps: "Google xaritasi",
  ...
  uz_cy: {
    ...
    venuebadge: "✦ Манзил ✦",
    venuesubtitle: "Севги ва нафосат уйғунлиги",
    googlemaps: "Google харитаси",
